...
export const CONNECT_ERROR_TEXT: Record<string, string> = {
  ...
  scan_needs_admin:
    "Your organization requires admin approval for the scan's delegated permissions. An Application Administrator or Cloud Application Administrator can run it, or you can start with the CSV import below.",
  ...
  scan_workspace_role:
    "This imported workspace already has data, and refreshing it needs an admin role. Ask a workspace admin to refresh it.",
  scan_mismatch:
